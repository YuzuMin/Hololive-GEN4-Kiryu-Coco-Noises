    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppYoutube.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://www.youtube.com/channel/UCS9uQI-jC3DE0L4IpXyvr6w"));
                startActivity(i);
            }
        });
        ...
        AppDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(android.content.Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://github.com/YuzuMin/Hololive-GEN4-Kiryu-Coco-Noises/tree/main/Assets"));
                startActivity(i);
