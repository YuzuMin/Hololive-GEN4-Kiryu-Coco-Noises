...
public class ClickerSettings extends AppCompatActivity {
    ...
    TableRow AmeliaIMG0Row;
    TableRow AmeliaIMG1Row;
    TableRow AmeliaIMG2Row;
    TableRow AmeliaIMG3Row;
    TableRow AmeliaIMG4Row;
    RadioButton AmeliaIMG0;
    RadioButton AmeliaIMG1;
    RadioButton AmeliaIMG2;
    RadioButton AmeliaIMG3;
    RadioButton AmeliaIMG4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AmeliaIMG0=findViewById(R.id.amelia0_img);
        AmeliaIMG0Row=findViewById(R.id.amelia0_img_row);
        AmeliaIMG1=findViewById(R.id.amelia1_img);
        AmeliaIMG1Row=findViewById(R.id.amelia1_img_row);
        AmeliaIMG2=findViewById(R.id.amelia2_img);
        AmeliaIMG2Row=findViewById(R.id.amelia2_img_row);
        AmeliaIMG3=findViewById(R.id.amelia3_img);
        AmeliaIMG3Row=findViewById(R.id.amelia3_img_row);
        AmeliaIMG4=findViewById(R.id.amelia4_img);
        AmeliaIMG4Row=findViewById(R.id.amelia4_img_row);


        AmeliaIMG0.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                AmeliaIMG0.setChecked(true);
                AmeliaIMG1.setChecked(false);
                AmeliaIMG2.setChecked(false);
                AmeliaIMG3.setChecked(false);
                AmeliaIMG4.setChecked(false);
            }
        });
        AmeliaIMG0Row.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=0;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
        ...
        AmeliaIMG1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=1;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
                SoundSettingsEditor.putInt("CharaValue",charavalue);
                SoundSettingsEditor.apply();
                AmeliaIMG0.setChecked(false);
                AmeliaIMG1.setChecked(true);
                AmeliaIMG2.setChecked(false);
                AmeliaIMG3.setChecked(false);
                AmeliaIMG4.setChecked(false);
            }
        });
        AmeliaIMG1Row.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=1;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
        ...
        AmeliaIMG2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=2;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
                ...
                AmeliaIMG0.setChecked(false);
                AmeliaIMG1.setChecked(false);
                AmeliaIMG2.setChecked(true);
                AmeliaIMG3.setChecked(false);
                AmeliaIMG4.setChecked(false);
            }
        });
        AmeliaIMG2Row.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=2;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
        ...
        AmeliaIMG3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=3;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
                ...
                AmeliaIMG1.setChecked(false);
                AmeliaIMG2.setChecked(false);
                AmeliaIMG3.setChecked(true);
                AmeliaIMG4.setChecked(false);
            }
        });
        AmeliaIMG3Row.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=3;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
        ...
        AmeliaIMG4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=4;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
                ...
                AmeliaIMG2.setChecked(false);
                AmeliaIMG3.setChecked(false);
                AmeliaIMG4.setChecked(true);
            }
        });
        AmeliaIMG4Row.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=4;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
        ...
        // for switch N to activate
        switchN=findViewById(R.id.switchN);
        SoundSettings =getSharedPreferences("saveN",MODE_PRIVATE);
        switchN.setChecked(SoundSettings.getBoolean("valueN",false));
        switchN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(switchN.isChecked()){
                    SoundSettingsEditor =getSharedPreferences("saveN",MODE_PRIVATE).edit();
                    SoundSettingsEditor.putBoolean("valueN",true);
                    SoundSettingsEditor.apply();
                    switchN.setChecked(true);
                    SoundSettingContainer.setVisibility(VISIBLE);
                }else{
                    SoundSettingsEditor =getSharedPreferences("saveN",MODE_PRIVATE).edit();
                    SoundSettingsEditor.putBoolean("valueN",false);
                    SoundSettingsEditor.apply();
...
// for switch 54 to activate
        ...
        switch54.setChecked(SoundSettings.getBoolean("value54",false));
...
// for switch 55 to activate
        ...
        switch55.setChecked(SoundSettings.getBoolean("value55",false));
...
// for switch 56 to activate
        ...
        switch56.setChecked(SoundSettings.getBoolean("value56",false));
...
// for switch 57 to activate
        ...
        switch57.setChecked(SoundSettings.getBoolean("value57",false));
...
// for switch 58 to activate
        ...
        switch58.setChecked(SoundSettings.getBoolean("value58",false));
...
// for switch 59 to activate
        ...
        switch59.setChecked(SoundSettings.getBoolean("value59",false));
...
// for switch 60 to activate
        ...
        switch60.setChecked(SoundSettings.getBoolean("value60",false));
...
// for switch 61 to activate
        ...
        switch61.setChecked(SoundSettings.getBoolean("value61",false));
...
// for switch 62 to activate
        ...
        switch62.setChecked(SoundSettings.getBoolean("value62",false));
